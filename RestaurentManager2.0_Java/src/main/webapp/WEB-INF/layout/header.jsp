...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
    <div class="container-fluid align-center p-3" >
        <a class="navbar-brand" href="#" >Onl Fooding</a>
            ...
            <ul class="navbar-nav me-auto">
                ...
                <c:choose>
                    <c:when test="${pageContext.request.userPrincipal.name != null}">
                        <li class="nav-item">
                            <a class="nav-link text-info" href="<c:url value="/" />" >Xin Chào ${pageContext.request.userPrincipal.name}!</a>
                        </li>
                        <li class="nav-item">
