...
import com.ltn.components.JwtService;
...
//    @PostMapping(path = "/current-user", consumes = {
//        MediaType.MULTIPART_FORM_DATA_VALUE,
//        MediaType.APPLICATION_JSON_VALUE
//    })
//    @ResponseStatus(HttpStatus.CREATED)
//    public void addOrUpdateUser(@RequestParam Map<String, String> params, @RequestPart MultipartFile[] file) {
//        User u = new User();
//        u.setUsername(params.get("name"));
//        u.setEmail(params.get("email"));
//        u.setPhone(Long.parseLong(params.get("phone")));
//        if (file.length > 0)
//            u.setAvatar(file[0]);
